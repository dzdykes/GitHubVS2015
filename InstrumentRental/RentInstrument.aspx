<%@ Page Title="" Language="C#" MasterPageFile="~/SitePublic.Master" AutoEventWireup="true" CodeBehind="RentInstrument.aspx.cs" Inherits="InstrumentRental.RentInstrument" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <article class="article50">
        ...
        <asp:DetailsView ID="DV_Instrument" runat="server" AutoGenerateRows="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="Instrument_ID" DataSourceID="SDS_Instrument" ForeColor="Black" GridLines="None" CssClass="dvFull">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="Instrument_Price" HeaderText="Price/Day (USD)" SortExpression="Instrument_Price" />
            </Fields>
    ...
    <asp:SqlDataSource ID="SDS_Instrument" runat="server" ConnectionString="<%$ ConnectionStrings:BandRentalDB %>" 
        ...
        SelectCommand="SELECT [Instrument_ID], [Instrument_Type], [Instrument_Description], [Instrument_Price] FROM [Instruments] WHERE ([Instrument_ID] = ?)">
        <SelectParameters>
