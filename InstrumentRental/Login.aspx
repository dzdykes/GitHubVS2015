    ...
    <div id="DivWrapper">
                ...
                <table class="signUpTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDL_HowFound" runat="server" AutoPostBack="True">
                                    <asp:ListItem Text="" Value="no answer"></asp:ListItem>
                                ...
                                <br />
                                <asp:TextBox ID="TB_Other" runat="server" Visible="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <asp:SqlDataSource ID="SDS_Renter" runat="server" ConnectionString="<%$ ConnectionStrings:BandRentalDB %>" 
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="DDL_HowFound" Name="Renter_HowFound" PropertyName="SelectedValue" Type="String" />
